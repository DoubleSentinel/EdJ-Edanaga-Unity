...
public class SineDance2D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (rotate)
        {
            Vector3 rotationVector = new Vector3(transform.rotation.x, transform.rotation.y, startRotation.z + sinRotAmpZ * Mathf.Sin((Time.time + offsetAmount) * sinRotSpeedZ));
...
[CustomEditor(typeof(SineDance2D))]
public class SinDance2DEditor : Editor
{
    override public void OnInspectorGUI()
    {
       var sinDance = target as SineDance2D;
